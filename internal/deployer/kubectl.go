...
func (d *Deployer) runKubectl(ctx context.Context, opts KubectlOptions) (*KubectlResult, error) { // perhaps this should not return a pointer so that the lack of nil checks elsewhere is robust?
