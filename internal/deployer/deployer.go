...
const (
	...
	// (6 main images + 2 operator images: stackrox-operator + stackrox-operator-bundle).
	// Main images: main, scanner, scanner-db, scanner-v4, scanner-v4-db, central-db
